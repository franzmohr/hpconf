...
[![CRAN status](https://www.r-pkg.org/badges/version/hpconf)](https://cran.r-project.org/package=hpconf)
[![Build Status](https://app.travis-ci.com/franzmohr/hpconf.svg?branch=master)](https://app.travis-ci.com/franzmohr/hpconf)
